...
class VeterinarianTool(BaseTool):
    """Tool for performing veterinary knowledge base search with optional reranking"""

    def __init__(self):
        super().__init__()
        self.name = "veterinary_search"
        self.description = (
            "Veterinary knowledge base containing articles written by "
            "veterinarians to keep pets healthy and happy. Provides "
            "veterinary and client education content including information "
            "on animal diseases, medications, treatments, preventive care, "
            "and general pet health advice. Use for questions about "
            "animal health, veterinary medicine, pet care, animal diseases, "
            "treatments, medications, or any veterinary-related topics."
        )
    ...
    def _initialize_mvc(self):
        ...
        self.similarity_search = SimilaritySearch(
            ...
            db_name="vetpartner",  # Use veterinary database
                ...
                "parameters": {
                    ...
                    "properties": {
                        "query": {
                            "type": "string",
                            "description": (
                                "User query to pass to the veterinary"
                                " knowledge base. Use for questions about"
                                " animal health, veterinary medicine, pet"
                                " care, animal diseases, treatments,"
                                " medications, preventive care, or any"
                                " veterinary-related topics. This includes"
                                " questions about dogs, cats, birds, reptiles,"
                                " and other pets."
                            ),
                        },
                    },
...
def get_veterinary_tool_definition() -> Dict[str, Any]:
    """
    Get the OpenAI-compatible tool definition for veterinary search
    ...
    tool = get_tool("veterinary_search")
    if tool:
        return tool.get_definition()
    else:
        raise RuntimeError("Failed to get veterinary tool definition")
